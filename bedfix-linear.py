...
# BEDFIX-LINEAR.PY - output a G-code script to set the bed-level mesh
# computes a least squares fit of the existing bed-level mesh to a plane
#
# SYNOPSIS:
# bedfix-linear.py CALIBRAT.TXT|BEDLEVEL.TXT 
...
XY = [ [ float(x), float(y), 1.0 ] for x,y,z in DATA ]
...
print('; bilinear bed level mesh, least-square fit to plane')
print('; z = {:.6e} x + {:.6e} y + {:.6e}'.format(*COEF))
